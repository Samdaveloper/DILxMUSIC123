...
from DILX.misc import db
from DILX.utils import (DILbin, get_channeplayCB,
                              seconds_to_min)
from DILX.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from DILX.utils.decorators.language import language, languageCB
from DILX.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://graph.org/file/49626af047c288c9a3743.jpg",
        caption=_["queue_1"],
    )
