...
from DILX import Telegram, YouTube, app
from DILX.misc import SUDOERS
from DILX.plugins.playlist import del_plist_msg
from DILX.plugins.sudoers import sudoers_list
from DILX.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
                                       get_assistant, get_lang,
                                       get_userss, is_on_off,
                                       is_served_private_chat)
from DILX.utils.decorators.language import LanguageStart
from DILX.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/official_eagle_team) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
|| ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [ꭙ𝐃🦋](https://t.me/Lover_jerry) 🥀 ||

ꭙ𝐃🦋[💖] sᴇᴀʀᴄʜ ᴩᴏᴡᴇʀᴇᴅ ʙʏ {config.MUSIC_BOT_NAME}"""
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="🍁•sᴜᴩᴩᴏʀᴛ[ꭙ𝐃🦋]🍁•", url="https://t.me/official_eagle_team"
                        ),
                    ],
                ]
            )
